  ...
  return (
    <div className='px-10 py-10'>
      <div className='text-center pb-14'>
        <h1 className='text-4xl pb-3 font-bold'>Featured Products</h1>
        <h2 className='text-xs opacity-50'>Summer Collection New Modern Design</h2>
      </div>
      ...
      {items.map((item) => (
        ...
        <div key={item.id} className="col-span-1 bg-white p-4 rounded-xl shadow-lg cursor-pointer hover:text-[#B70000]">
            <img src={item.imgUrl} className='w-full rounded-xl'/>
          <div className='opacity-50 py-2'>{item.brandName}</div>
          <h1 className='font-bold pt-2'>{item.title}</h1>
          <svg width="90" height="90" viewBox="0 0 28 4" fill="none" xmlns="http://www.w3.org/2000/svg">
